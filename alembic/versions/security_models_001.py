...
def upgrade() -> None:
    ...
    op.execute(
        text(
            "CREATE INDEX IF NOT EXISTS ix_credential_vaults_id "
            "ON credential_vaults (id)"
        )
    )
    ...
    op.execute(
        text(
            "CREATE INDEX IF NOT EXISTS ix_credential_use_logs_id "
            "ON credential_use_logs (id)"
        )
    )
    ...
    op.execute(
        text(
            "CREATE INDEX IF NOT EXISTS ix_user_consents_id "
            "ON user_consents (id)"
        )
    )
    op.execute(
    ...
    op.execute(
        text(
            "CREATE INDEX IF NOT EXISTS ix_consent_versions_id "
            "ON consent_versions (id)"
        )
    )
