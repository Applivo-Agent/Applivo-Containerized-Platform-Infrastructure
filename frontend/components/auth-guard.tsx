    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="glass-card p-10 text-center max-w-md">
          ...
          <a
            href="/pricing"
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-brand-purple text-white rounded-lg hover:bg-brand-purple/90 transition-colors text-sm font-medium"
          >
            View Plans
          </a>
        </div>
