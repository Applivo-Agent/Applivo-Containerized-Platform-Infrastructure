...
class Interview(Base, UUIDMixin, TimestampMixin):
    ...
    interview_type: Mapped[InterviewType] = mapped_column(Enum(InterviewType, name="interviewtype"), nullable=False)
...
class Notification(Base, UUIDMixin, TimestampMixin):
    ...
    status: Mapped[NotificationStatus] = mapped_column(
        Enum(NotificationStatus, name="notificationstatus"), default=NotificationStatus.PENDING, nullable=False, index=True
    )
...
class AgentTaskType(str, enum.Enum):
    ...
    ANALYZE_AND_QUEUE = "ANALYZE_AND_QUEUE"
...
class AgentTask(Base, UUIDMixin, TimestampMixin):
    ...
    task_type: Mapped[AgentTaskType] = mapped_column(
        Enum(AgentTaskType, name="agenttasktype", values_callable=lambda obj: [e.value for e in obj]), 
        nullable=False, 
        index=True
    )
    status: Mapped[AgentTaskStatus] = mapped_column(
        Enum(AgentTaskStatus, name="agenttaskstatus", values_callable=lambda obj: [e.value for e in obj]), 
