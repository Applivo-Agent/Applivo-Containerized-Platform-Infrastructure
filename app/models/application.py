...
class Application(Base, UUIDMixin, TimestampMixin):
    ...
    status: Mapped[ApplicationStatus] = mapped_column(
        Enum(ApplicationStatus, name="applicationstatus", values_callable=lambda obj: [e.value for e in obj]),
        default=ApplicationStatus.QUEUED,
        nullable=False,
        index=True,
    )
    method: Mapped[ApplicationMethod] = mapped_column(
        Enum(ApplicationMethod, name="applicationmethod", values_callable=lambda obj: [e.value for e in obj]),
    ...
    follow_up_status: Mapped[FollowUpStatus] = mapped_column(
        Enum(FollowUpStatus, name="followupstatus", values_callable=lambda obj: [e.value for e in obj]), 
